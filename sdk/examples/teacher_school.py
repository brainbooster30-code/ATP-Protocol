...
Scenario:
  ...
  ATP v1.6.1 provides secure, attested communication with MCC-bound identities.
...
async def main():
    print("═" * 64)
    print("  🏠  Prof. Rossi (casa)  ←──ATP v1.6.1──→  🏫  Scuola Futura")
    print("═" * 64)
    print()
    ...
    print(f"  Protocollo:       ATP v1.6.1 — MCC-attested")
